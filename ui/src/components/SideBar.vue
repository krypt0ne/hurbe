...
import HurbeLogo from '@/components/icons/HurbeLogo.vue';
...
import { hurbeTokenId } from '@/scripts/contract';
import { ref } from "vue";

const importing = ref<boolean>(false);

const importHurbe = async () => {
    // if (importing.value) return;
    // importing.value = true;
    // await Metamask.addToMetamask(hurbeTokenId, 'HUB', 'https://hurbe.xyz/images/logo.png');
...
<template>
    <main>
        ...
        <div class="overflow">
            <div class="tab_items">
                ...
                <div class="tab_parent">
                    <RouterLink to="/ai">
                        <div class="title">
                            <BubbleIcon :color="(route.name as string)?.startsWith('ai') ? 'var(--tx-semi)' : '#ABADAE'" />
                            <h3>Hurbe AI</h3>
                            <div
        ...
        <div class="links">
            <button class="support" @click="importHurbe">
                <img src="/images/logo.png" alt="">
                <p>{{ importing ? 'Adding' : '$HUB' }}</p>
            </button>
            <div class="socials">
                <a href="#">
