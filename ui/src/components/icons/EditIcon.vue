<template>
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M9.9082 4.20837C10.2665 6.50837 12.1332 8.26671 14.4499 8.50004"
            :stroke="props.color || 'var(--tx-semi)'" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
            stroke-linejoin="round" />
        <path d="M2.5 18.3334H17.5" :stroke="props.color || 'var(--tx-semi)'" stroke-width="1.5" stroke-miterlimit="10"
