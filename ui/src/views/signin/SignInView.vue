...
const connectWallet = () => {
    ...
    if (walletStore.walletType == WalletType.SignInWithGoogle) {
        notify.push({
...
const fetchAccount = async (address: string) => {
    ...
    const account = await HurbeAPI.getAccount(address);
...
const accountCreation = async (form: AccountForm) => {
    ...
    const account = await HurbeAPI.createAccount(
        walletStore.address,
        form.name,
        form.email,
        form.image
        ...
        <div class="app_width">
            <div class="signin">
                ...
                <div class="signin_wallets">
                    ...
                    <div :class="walletStore.walletType == WalletType.SignInWithGoogle ? `signin_wallet signin_wallet_active` : `signin_wallet`"
                        @click="() => { selectWalletType(WalletType.SignInWithGoogle); }">
                        <div class="signin_wallet_name">
