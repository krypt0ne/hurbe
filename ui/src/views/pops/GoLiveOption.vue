    ...
    <div class="blur">
        <div class="container">
            ...
            <div class="title">
                ...
                <p>Choose a suitable Broadcast Method for your stream to Continue.</p>
            </div>
            ...
            <div class="viewers">
                <div class="viewer" @click="streamType = StreamType.Direct">
                    ...
                    <p class="viewer_desc">
                        Go live sharing your screen using Hurbe’s Broadcasting setup presets , Recommend for users new
                        to streaming.
                    </p>
                </div>
                ...
                <div class="viewer" @click="streamType = StreamType.External">
                    ...
                    <p class="viewer_desc">
                        Broadcast your stream to Hurbe from an external software with control over your choice of
