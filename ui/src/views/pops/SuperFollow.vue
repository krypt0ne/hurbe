...
<template>
    <div class="blur">
        <div class="container">
            ...
            <div class="title">
                <h3>
                    <FlashIcon /> Super Follow
                </h3>
                <p>To be eligible to View all Exclusive contents on a channel, Super Follow it.</p>
            </div>

            <div class="amount">
                <img src="/images/hbar.png" alt="">
                <h3><span>{{ Converter.fromWei(props.amount) }}</span> HBAR</h3>
                <p>~$0.00</p>
            </div>
