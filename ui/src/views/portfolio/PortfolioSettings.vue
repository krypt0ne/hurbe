...
const updateChannel = async () => {
    ...
    const txHash1 = await Contract.createStreamer(
        JSON.stringify({
            ...
            image: 'https://hurbe.xyz/images/basic_nft.png'
        }),
        channel.value.name,
    ...
    const createdChannel = await HurbeAPI.createChannel(
        walletStore.address,
        channel.value.name!,
        image_url,
        cover_url
    ...
    const account = await HurbeAPI.getAccount(walletStore.address);
...
const getChannel = async () => {
    loading.value = true;
    existingChannel.value = await HurbeAPI.getChannel(walletStore.address as any);
        ...
        <div class="detail_form_wrapper">
            <div class="detail_form" v-show="activeTab == 1">
                ...
                <div class="input" v-show="!Boolean(existingChannel)">
                    <p class="label">Set Super Follow Fee (HBAR) <span>*</span></p>
