...
const HurbeAPI = {
  ...
  async followAccount(streamer: string, viewer: string): Promise<boolean> {
    try {
      const response = await client.post(
        `/follow-account/${streamer}/${viewer}`
      );
      return response.data;
    } catch (error) {
      console.error(error);
  ...
  async unfollowAccount(streamer: string, viewer: string): Promise<boolean> {
    try {
      const response = await client.post(
        `/unfollow-account/${streamer}/${viewer}`
      );
      return response.data;
    } catch (error) {
      console.error(error);
  ...
  async joinStream(viewer: string, streamId: string): Promise<boolean> {
    try {
  ...
  async likeStream(viewer: string, streamId: string): Promise<boolean> {
    try {
  ...
  async likeVideo(viewer: string, videoId: string): Promise<boolean> {
    try {
  ...
  async dislikeStream(viewer: string, streamId: string): Promise<boolean> {
    try {
      const response = await client.post(
        `/dislike-stream/${viewer}/${streamId}`
      );
      return response.data;
    } catch (error) {
      console.error(error);
  ...
  async dislikeVideo(viewer: string, videoId: string): Promise<boolean> {
    try {
  ...
  async watchVideo(viewer: string, videoId: string): Promise<boolean> {
    try {
  ...
  async getStreams(
    ...
    try {
      const response = await client.get(
        `/streams?page=${page}&streamer=${streamer}`
      );
      return response.data;
    } catch (error) {
      console.error(error);
  ...
  async startStream(
    ...
    try {
      const response = await client.post(
        `/start-stream/${streamId}?streamServer=${streamServer}&streamKey=${streamKey}`
      );
      return response.data;
    } catch (error) {
      console.error(error);
  ...
  async getVideos(
    ...
    try {
      const response = await client.get(
        `/videos?page=${page}&streamer=${streamer}`
      );
      return response.data;
    } catch (error) {
      console.error(error);
  ...
  async getVideo(streamId: string): Promise<Video | null> {
    try {
  ...
  async getChannels(page: number): Promise<Paged<Channel[]> | null> {
    try {
  ...
  async getChannel(address: string): Promise<Channel | null> {
    try {
